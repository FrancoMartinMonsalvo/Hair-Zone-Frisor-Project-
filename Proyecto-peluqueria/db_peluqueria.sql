...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-10-2023 a las 06:58:36
...
--
ALTER TABLE `trabajos`
  ADD CONSTRAINT `trabajos_ibfk_1` FOREIGN KEY (`cliente_id`) REFERENCES `clientes` (`cliente_id`);
COMMIT;
